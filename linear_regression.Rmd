...
__Examine the data before fitting models__

__Start by examining the data to check for problems.__
...
__Plot the data before fitting models__
...
__Why is the association between expense and SAT scores /negative/?__
...
-   repeat steps 1-3. Is this model significantly better than the model with /metro/ as the only predictor?
