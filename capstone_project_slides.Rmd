...
author: "Maria P. Frushicheva with mentor Rachel Wilkerson"
date: "August 16, 2016"
...
__Question:__ 
Can we predict hospital quality ratings based on risk adjusted mortality rates, number of deaths, number of cases, medical procedures performed and medical conditions treated for 2012-2013?
...
- Better and worse ratings are for Craniotomy, PCI, Acute Stroke, AMI, Heart Failure and GI Hemorrhage.
...
Number of hospitals with ratings "As Expected": 172, "Better": 69 and "Worse": 99. 
...
- Accuracy: `r round(call_a,4)` 
- Error Rate: `r round(call_e,4)`
...
- Accuracy: `r round(c3_a,4)` 
- Error Rate: `r round(c3_e,4)`
...
***
__Top 10 hospitals with the best overall ratings and the lowest mean mortality rate in state of California.__
```{r,warning=FALSE,message=FALSE,echo=FALSE}
...
***
Capstone Project Files are available online 
